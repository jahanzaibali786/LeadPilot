...
class LeadsExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents
{
    ...
    public function headings(): array { return ['Campaign','Service','Business Name','Category','Phone','WhatsApp','Address','City','Province','Rating','Reviews','Website Status','Website','Google Maps','Score','Quality','Status','Opportunity','Match Reason','Suggested Offer','WhatsApp English','WhatsApp Roman Urdu','Email Subject','Email Body','Source','Notes','Follow-up Date']; }
